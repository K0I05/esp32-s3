...
static void i2c_0_task( void *pvParameters ) {
    ...
    i2c_bmp280_config_t                 bmp280_dev_cfg = {
    ...
    //
    // i2c bus settling delay
    //vTaskDelayMs( 10 );
    //
    // task loop entry point
    for ( ;; ) {
        ESP_LOGI(CONFIG_APP_TAG, "main i2c_0_task entry");
        //
        // handle bmp280 sensor
        //float temperature;
        //float pressure;
        //if(i2c_bmp280_measure(bmp280_dev_hdl, &temperature, &pressure) != 0) {
